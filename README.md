...
2. 快速起步：看 [docs/skill-quickstart.md](./docs/skill-quickstart.md)
3. 完整流程：看 [docs/skill-authoring.md](./docs/skill-authoring.md)
4. 结构规范：看 [docs/skill-spec.md](./docs/skill-spec.md)
